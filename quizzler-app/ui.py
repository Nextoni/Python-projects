...
class QuizInterface:
    ...
    def __init__(self, quiz_brain: QuizBrain):
        ...
        self.true_button = Button(image= img_true, padx= 20, pady= 20, highlightthickness= 0, command= self.check_if_true)
        self.true_button.grid(row=2, column=0)

        img_false = PhotoImage(file="images/false.png")
        self.false_button = Button(image= img_false, padx= 20, pady= 20, highlightthickness= 0, command= self.check_if_false)
